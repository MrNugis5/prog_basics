...
def remove_sixes(six_dict: dict) -> dict:
    ...
    """
    result = {key: value for key, value in six_dict.items() if value % 6 != 0}
    return result
...
def exchange_keys_and_values(exchange_dict: dict) -> dict:
    ...
    """
    result = {value: key for key, value in exchange_dict.items()}
    return result
...
def count_symbol_appearances(stringy: str) -> dict:
    ...
    """
    result = {char: stringy.count(char)for char in stringy}
    return result
